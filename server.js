...
// -------------------------------------------------------------
// 📊 نظام مراقبة استهلاك موارد السيرفر (كل 10 ثوانٍ)
// -------------------------------------------------------------
setInterval(() => {
  const mem = process.memoryUsage();
  console.log(`[📊 وضع السيرفر] الرام المستهلكة: ${(mem.rss / 1024 / 1024).toFixed(2)} MB | الذاكرة الداخلية: ${(mem.heapUsed / 1024 / 1024).toFixed(2)} MB | عدد الطلبات المعلقة: ${activeDownloads.size}`);
}, 10000); // جعلتها كل 10 ثوانٍ لكي لا تزعجك كثيراً في التيرمينال
// -------------------------------------------------------------
